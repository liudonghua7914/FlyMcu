...
void I2C_SlaveHandler (LPC_I2C_TypeDef  *I2Cx)
{
	...
	case I2C_I2STAT_S_RX_SLAW_ACK:		   //0x60
	...
	case I2C_I2STAT_S_TX_DAT_ACK:	//0xB8
		 ...
		 * data length, just ignore them.
		 */
//		#if(DEVELOPMENT == QUALCOMM_DEVELOPMENT)
//		if(FIFO_GET_COUNT(IICTxFifo)){
//			FIFO_GET_ONE_INT(IICTxFifo,&data);
//			I2Cx->I2DAT = data;
//			txrx_setup->tx_count++;
//		}
//		else
