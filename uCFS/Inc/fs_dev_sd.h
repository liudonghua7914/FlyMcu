...
#ifndef  FS_DEV_SD_PRESENT
#define  FS_DEV_SD_PRESENT
...
#ifdef   FS_DEV_SD_MODULE
#define  FS_DEV_SD_EXT
#else
#define  FS_DEV_SD_EXT  extern
#endif
...
#define  FS_DEV_SD_DFLT_CLK_SPD                       400000u   /* Dflt clk spd, in Hz.                                 */

#define  FS_DEV_SD_BLK_SIZE                              512u

#define  FS_DEV_SD_RESP_MAX_LEN                           16u   /* Max resp len, in bytes.                              */

/*
*********************************************************************************************************
*                                       SD DEVICE TYPE DEFINES
*
* Note(s) : (1) FS_SD_TYPE_??? #define values specifically chosen as ASCII representations of the volume
*               types.  Memory displays of volume types will display the volume TYPE with the chosen
*               ASCII name.
*********************************************************************************************************
*/

#define  FS_DEV_SD_TYPE_NONE        FS_TYPE_CREATE(ASCII_CHAR_LATIN_UPPER_N,  \
                                                   ASCII_CHAR_LATIN_UPPER_O,  \
                                                   ASCII_CHAR_LATIN_UPPER_N,  \
                                                   ASCII_CHAR_LATIN_UPPER_E)

#define  FS_DEV_SD_TYPE_SPI         FS_TYPE_CREATE(ASCII_CHAR_LATIN_UPPER_S,  \
                                                   ASCII_CHAR_LATIN_UPPER_D,  \
                                                   ASCII_CHAR_SPACE,          \
                                                   ASCII_CHAR_SPACE)

#define  FS_DEV_SD_TYPE_CARD        FS_TYPE_CREATE(ASCII_CHAR_LATIN_UPPER_C,  \
...
#define  FS_DEV_SD_CMD8_CHK_PATTERN                     0xA5u
...
CPU_BOOLEAN  FSDev_SD_ParseCSD        (CPU_INT08U       csd[],      /* Parse CSD.                                       */
                                       FS_DEV_SD_INFO  *p_sd_info,
                                       CPU_INT08U       card_type);

CPU_BOOLEAN  FSDev_SD_ParseCID        (CPU_INT08U       cid[],      /* Parse CID.                                       */
                                       FS_DEV_SD_INFO  *p_sd_info,
                                       CPU_INT08U       card_type);

CPU_INT08U   FSDev_SD_ChkSumCalc_7Bit (CPU_INT08U      *p_data,     /* Calculate 7-bit CRC.                             */
                                       CPU_INT32U       size);

#if (FS_DEV_SD_SPI_CFG_CRC_EN == DEF_ENABLED)
CPU_INT16U   FSDev_SD_ChkSumCalc_16Bit(CPU_INT08U      *p_data,     /* Calculate 16-bit CRC.                            */
                                       CPU_INT32U       size);
#endif

#if (FS_TRACE_LEVEL >= TRACE_LEVEL_INFO)
void         FSDev_SD_TraceInfo       (FS_DEV_SD_INFO  *p_sd_info); /* Output SD trace info.                            */
#endif

void         FSDev_SD_ClrInfo         (FS_DEV_SD_INFO  *p_sd_info); /* Clr SD info.                                     */


CPU_BOOLEAN  FSDev_SD_ParseEXT_CSD    (CPU_INT08U       ext_csd[],  /* Parse EXT_CSD reg.                               */
                                       FS_DEV_SD_INFO  *p_sd_info);
...
#endif                                                          /* End of SD module include.                            */
